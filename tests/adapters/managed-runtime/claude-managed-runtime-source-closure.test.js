...
import {
  parseHostArgv,
} from '../../../src/adapters/managed-runtime/claude-managed-runtime-host.js';
...
test('managed Claude host pins its verifier and accepts only one fixed manifest slot', () => {
  const host = readFileSync(
    new URL('../../../src/adapters/managed-runtime/claude-managed-runtime-host.js', import.meta.url),
    'utf8',
  );
  const closure = readFileSync(
    new URL('../../../src/adapters/managed-runtime/claude-managed-runtime-source-closure.js', import.meta.url),
  );
