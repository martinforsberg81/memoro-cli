...
mc does not stop or restart anything — admission included: a server that is
refused waits or gives up, and nothing running is stopped to make room. It holds an index and answers questions
