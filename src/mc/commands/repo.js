...
export function parseArgs(argv) {
  ...
  // The scheduled full run moved to the verb whose round it runs (2026-09-04).
  // Answered here rather than aliased: a legacy verb that still works is a
  // verb nobody retires.
  if (opts.verb === 'nightly') return { ...opts, error: 'mc repo nightly is now mc test nightly' };
