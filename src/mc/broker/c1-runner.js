...
const LEASE_HOST_PATH = join(PACKAGE_ROOT, 'src', 'mc', 'broker', 'c1-lease-host.js');
const SOURCE_CLOSURE_PATH = join(PACKAGE_ROOT, 'src', 'mc', 'broker', 'c1-source-closure.js');
...
const C1_SOURCE_CLOSURE_SOURCE_SHA256 =
  '7e6c6e6e8e127f2e306df48651f689828fec761a220610e8bf6f1b4f0120d71b';
