...
} from '../broker/c1-process-group.js';
import { verifyInstalledC1SourceClosure } from '../broker/c1-source-closure.js';
...
const CHILD_PATH = join(PACKAGE_ROOT, 'src', 'mc', 'broker', 'c1-child.js');
