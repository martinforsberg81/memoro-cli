 ...
 *
 * Legacy helper: fetches the portrait-coding lens in untrimmed "sections"
 * mode and prints one section's markdown to stdout. The normal mc startup path
 * uses User Profile + Coding Profile context, not this lens surface.
 *
 * Exit codes:
...
// Hyphenated CLI names → legacy lens section keys.
