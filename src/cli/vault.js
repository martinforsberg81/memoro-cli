...
import {
  ...
  importVaultKey,
} from '../vault/engine/client-crypto.js';
import {
  CRK_RECOVERY_AAD,
...
} from '../vault/engine/custody-crypto.js';
import { ensureCustodyRoot, encryptForWrite } from '../vault/engine/custody-session.js';
import { captureToolAuth, hydrateToolAuth, resolveToolAuthSpec } from '../vault/engine/tool-auth.js';
import {
  buildSecretPayload,
...
} from '../vault/engine/key-cache.js';
import { buildVaultImportDryRun, parseDotenv, scanVaultImportFiles } from '../vault/engine/import-scan.js';
import {
  ...
  readSecretBindings,
} from '../vault/engine/bindings.js';
import { auditVaultExposure } from '../vault/engine/audit.js';
