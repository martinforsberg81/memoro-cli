...
import {
  conflictsWithStoredAuthority,
  worktreeBelongsToPrimary,
  inspectAuthority,
  isBackfillableIssue,
  inspectManagedToolAuthority,
  inspectMcAuthority,
  isVerifiedMissingRetry,
  teardownOne,
...
import { resolveToolSessionForResume } from '../mc/tool-session.js';
import {
