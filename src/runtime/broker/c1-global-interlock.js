...
const INSTALL_IDENTITY_INPUTS = Object.freeze([
  ...
  'src/runtime/broker/c1-global-interlock.js',
  'src/runtime/broker/c1-install-receipt.js',
  'src/runtime/broker/runtime.js',
  'src/cli/storage.js',
  'src/vault/credential-domain/local-codex.js',
  'src/mc/managed-codex-recovery.js',
  'src/adapters/managed-runtime/codex-managed-artifacts.js',
  'src/adapters/managed-runtime/codex-managed.js',
